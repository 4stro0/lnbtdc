...
module.exports = {
  ...
  category: "General", //the command category for helpcmd [OPTIONAL]
  aliases: ["uinfo", "whoami","whois"], //the command aliases for helpcmd [OPTIONAL]
  cooldown: 5, //the command cooldown for execution & for helpcmd [OPTIONAL]
  usage: "userinfo [@USER] [global]", //the command usage for helpcmd [OPTIONAL]
  description: "Shows Information of a User", //the command description for helpcmd [OPTIONAL]//Only allow members with specific Permissions to execute a Commmand [OPTIONAL]
